    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rquired_quiz', models.OneToOneField(blank=True, help_text='The prerequisite quiz for the task', null=True, on_delete=django.db.models.deletion.CASCADE, to='quiz.Quiz', verbose_name='required_quiz')),
            ],
            options={
                'verbose_name': 'task',
